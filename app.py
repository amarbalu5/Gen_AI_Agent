...
groq_api_key = os.getenv("GROQ_API_KEY", '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')  # Groq API key
os.environ["TAVILY_API_KEY"] = os.getenv("TAVILY_API_KEY", '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')  # Set Tavily API key
